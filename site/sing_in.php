			...
			<?php
			    ...
			    if($user) {
					...
					if(password_verify($data['password'], $user->password)) {
						...
						echo '<div style="color: green; ">Ви успішно авторизовані! Можна перейті на <a href="index.php">головну сторінку</a>.</div><hr>';
			    
					} else {
						$errors[] = 'Пароль введено невірно!';
			    	}
			    
			    } else {
					$errors[] = 'Вибачте, такого користувача не знайдено! ';
			    }
